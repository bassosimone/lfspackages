...
pkg_build() {
    pkg_build_autotools
    pkg_lib_run sudo chmod +x ${__pkg_install_prefix}/${__pkg_distro_name}/lib/libhogweed.so.6.8
    pkg_lib_run sudo chmod +x ${__pkg_install_prefix}/${__pkg_distro_name}/lib/libnettle.so.8.8
}
